...
fn test_example_1() {
    ...
    let group_size = 3;
    assert_eq!(Solution::is_n_straight_hand(hand, group_size), true);
}
...
fn test_example_2() {
    ...
    let group_size = 4;
    assert_eq!(Solution::is_n_straight_hand(hand, group_size), false);
}
...
fn test_large_numbers() {
    ...
    let hand = vec![1000000000, 1000000001, 1000000002, 1000000003, 1000000004, 1000000005];
    let group_size = 2;
    assert_eq!(Solution::is_n_straight_hand(hand, group_size), true);
}
