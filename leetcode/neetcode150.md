...
- [x] 40. [Copy List With Random Pointer](https://leetcode.com/problems/copy-list-with-random-pointer/)
...
- [x] 74. [Palindrome Partitioning](https://leetcode.com/problems/palindrome-partitioning/)
...
- [x] 113. [Best Time to Buy And Sell Stock With Cooldown](https://leetcode.com/problems/best-time-to-buy-and-sell-stock-with-cooldown/)
...
- [x] 128. [Partition Labels](https://leetcode.com/problems/partition-labels/)
- [x] 129. [Valid Parenthesis String](https://leetcode.com/problems/valid-parenthesis-string/)
...
- [x] 135. [Minimum Interval to Include Each Query](https://leetcode.com/problems/minimum-interval-to-include-each-query/)
...
- [x] 144. [Single Number](https://leetcode.com/problems/single-number/)
- [x] 145. [Number of 1 Bits](https://leetcode.com/problems/number-of-1-bits/)
